...
class RecipeItemInfoPanel extends StatefulWidget {
  const RecipeItemInfoPanel(
      ...
      this.openDrawer,
      required this.seekToTime, required this.onPanelClose})
      : super(key: key);
            ...
            child: ListView(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: List.generate(widget.model.recipeSteps.length,
                        ((index) {
                      return RecipeStepCard(
                        ...
                        stepNumber: widget.model.recipeSteps[index]
                            ['stepNumber'],
                        stepName: widget.model.recipeSteps[index]['stepName'],
                        stepContext: widget.model.recipeSteps[index]
                            ['stepContext'],
                        model: widget.model,
                ...
                ListView.builder(
                    ...
                    itemBuilder: (context, index) => ChatCommentWidget(
                          ...
                          userImage: widget.model.userComment[index]
                              ["userImage"],
