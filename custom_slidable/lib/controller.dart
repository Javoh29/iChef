...
class CustomSlidableController {
  ...
  CustomSlidableController(TickerProvider vsync)
      : _animationController = AnimationController(vsync: vsync),
        ...
        actionPaneType = ValueNotifier(CustomActionPaneType.none),
  ...
  final ValueNotifier<CustomActionPaneType> actionPaneType;
  ...
  void _onDirectionChanged() {
    ...
    actionPaneType.value = CustomActionPaneType.values[index];
  }
  ...
  Future<void> openStartActionPane({
    ...
    if (actionPaneType.value != CustomActionPaneType.start) {
  ...
  Future<void> openEndActionPane({
    ...
    if (actionPaneType.value != CustomActionPaneType.end) {
      direction.value = isLeftToRight ? -1 : 1;
      ratio = 0;
    }
